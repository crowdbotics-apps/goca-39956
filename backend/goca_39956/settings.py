"""
Django settings for goca_39956 project.
...
WSGI_APPLICATION = 'goca_39956.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "goca_39956 API",
    "DESCRIPTION": "API documentation for goca_39956 App",
    "VERSION": "v1",
}
